...
public class Utils extends TestBase {
	...
	public static String generateRandomString(int cnCnt) {
		return RandomStringUtils.random(cnCnt);// ths method creates random character and returns string

	}

	public static String generateRandomAlphaNumeric(int chCnt) {
		return RandomStringUtils.random(chCnt);//
	}
